...
#' bib record a .md file. The name of the .md file is generated from
#' the year and entry field. It has the format \code{year-month-day_key.md}
#'
#'
#' @section Required parameters:
#' The only function of this package is `bib2acad()``
#' The bib2acad function needs one parameter.
#'
